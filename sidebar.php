...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        <div class="profile-sidebar">
            <div class="profile-userpic">
                <img src="mmlogo.png" class="img-responsive" alt="">
            </div>
            <div class="profile-usertitle">
                <?php
$uid=$_SESSION['detsuid'];
$ret=mysqli_query($con,"select username from registration where id  ='$uid'");
...
?>
        ...
        <ul class="nav menu">
            <li class="active"><a href="dashboard1.php"><em class="fa fa-dashboard">&nbsp;</em> Dashboard</a></li>
  ...
  <li class="parent "><a data-toggle="collapse" href="#sub-item-2">
            ...
            <li><a href="new.html">Information</a></li>
